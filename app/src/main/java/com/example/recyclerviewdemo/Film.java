...
public class Film {
    ...
    public Film(String titre, String horaire1, String horaire2, String horaire3, String horaire4, String vost1, String vost2, String vost3, String vost4, int imageResId, int ageRequis) {
        this.titre = titre;
